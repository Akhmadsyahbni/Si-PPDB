              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Input username & password siswa</p>
                  </div>

                  <form action="{{route('user.check')}}" method="post" autocomplete="off"class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <p class="small mb-0">Lupa kata sandi? <a href="{{route('user.forget.password.form')}}">Reset kata sandi!</a></p>
                      </div>
                  </form>
                </div>
              </div>
